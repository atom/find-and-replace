...
class ProjectFindView extends View
  ...
  replaceAll: ->
    ...
    @model.search(pattern, replacementPattern, @getPaths(), onlyRunIfChanged: true).then =>
      @clearMessages()
