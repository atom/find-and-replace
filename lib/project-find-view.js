...
class ProjectFindView {
  ...
  render() {
    return (
      etch.dom.div({tabIndex: -1, className: 'project-find padded'},
        etch.dom.header({className: 'header'},
          ...
          etch.dom.span({className: 'header-item options-label pull-right'},
            ...
            etch.dom.span({className: 'btn-group btn-toggle btn-group-options'},
              etch.dom.button({ref: 'regexOptionButton', className: 'btn option-regex'},
                etch.dom.svg({className: "icon", innerHTML: `<use xlink:href="#find-and-replace-icon-regex" />`})
              ),
              etch.dom.button({ref: 'caseOptionButton', className: 'btn option-case-sensitive'},
                etch.dom.svg({className: "icon", innerHTML: `<use xlink:href="#find-and-replace-icon-case" />`})
              ),
              etch.dom.button({ref: 'wholeWordOptionButton', className: 'btn option-whole-word'},
                etch.dom.svg({className: "icon", innerHTML:`<use xlink:href="#find-and-replace-icon-word" />`})
              )
            )
          )
        ),

        etch.dom.section({ref: 'replacmentInfoBlock', className: 'input-block'},
          etch.dom.progress({ref: 'replacementProgress', className: 'inline-block'}),
          etch.dom.span({ref: 'replacmentInfo', className: 'inline-block'}, 'Replaced 2 files of 10 files')
        ),
        ...
        etch.dom.section({className: 'input-block find-container'},
          ...
          etch.dom.div({className: 'input-block-item'},
            etch.dom.div({className: 'btn-group btn-group-find'},
              etch.dom.button({ref: 'findAllButton', className: 'btn'}, 'Find All')
            )
          )
        ),
        ...
        etch.dom.section({className: 'input-block replace-container'},
          ...
          etch.dom.div({className: 'input-block-item'},
            etch.dom.div({className: 'btn-group btn-group-replace-all'},
              etch.dom.button({ref: 'replaceAllButton', className: 'btn disabled'}, 'Replace All')
            )
          )
        ),

        etch.dom.section({className: 'input-block paths-container'},
          etch.dom.div({className: 'input-block-item editor-container'},
            etch.dom(TextEditor, {
              ref: 'pathsEditor',
              mini: true,
