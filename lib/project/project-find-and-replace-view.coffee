...
class ProjectFindAndReplaceView extends View
  ...
  @content: ->
    @div class: 'find-and-replace project-find-and-replace tool-panel panel-bottom', =>

      @div class: 'loading is-loading pull-center loading-spinner-small', outlet: 'loadingMessage'

      @div class: 'inset-panel', =>
        @div class: 'panel-heading', outlet: 'previewHeader', =>
      ...
      @div class: 'find-container', =>
        @label outlet: 'findLabel', class: 'pull-left', 'Find'
