  ...
  render() {
    ...
    return (
      etch.dom.li(
        ...
        etch.dom.div({ref: 'pathDetails', className: 'path-details list-item'},
          etch.dom.span({className: 'disclosure-arrow'}),
          etch.dom.span({
            className: iconClass.join(' ') + ' icon',
            dataset: {name: path.basename(this.filePath)}
          }),
          etch.dom.span({className: 'path-name bright'},
            relativePath
          ),
          etch.dom.span({ref: 'description', className: 'path-match-number'},
