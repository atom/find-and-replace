...
class FindView {
  ...
  render() {
    return (
      etch.dom.div({tabIndex: -1, className: 'find-and-replace'},
        etch.dom.header({className: 'header'},
          etch.dom.span({ref: 'descriptionLabel', className: 'header-item description'},
            'Find in Current Buffer'
          ),

          etch.dom.span({className: 'header-item options-label pull-right'},
            etch.dom.span({}, 'Finding with Options: '),
            etch.dom.span({ref: 'optionsLabel', className: 'options'}),
            etch.dom.span({className: 'btn-group btn-toggle btn-group-options'},
              etch.dom.button({ref: 'regexOptionButton', className: 'btn'},
                etch.dom.svg({className: "icon", innerHTML: '<use href="#find-and-replace-icon-regex" />'})
              ),

              etch.dom.button({ref: 'caseOptionButton', className: 'btn'},
                etch.dom.svg({className: "icon", innerHTML: '<use href="#find-and-replace-icon-case" />'})
              ),

              etch.dom.button({ref: 'selectionOptionButton', className: 'btn option-selection'},
                etch.dom.svg({className: "icon", innerHTML: '<use href="#find-and-replace-icon-selection" />'})
              ),

              etch.dom.button({ref: 'wholeWordOptionButton', className: 'btn option-whole-word'},
                etch.dom.svg({className: "icon", innerHTML: '<use href="#find-and-replace-icon-word" />'})
              )
            )
          )
        ),

        etch.dom.section({className: 'input-block find-container'},
          etch.dom.div({className: 'input-block-item input-block-item--flex editor-container'},
            etch.dom(TextEditor, {
              ref: 'findEditor',
              mini: true,
            ...
            etch.dom.div({className: 'find-meta-container'},
              etch.dom.span({ref: 'resultCounter', className: 'text-subtle result-counter'})
            )
          ),

          etch.dom.div({className: 'input-block-item'},
            etch.dom.div({className: 'btn-group btn-group-find'},
              etch.dom.button({ref: 'nextButton', className: 'btn btn-next'}, 'Find')
            ),

            etch.dom.div({className: 'btn-group btn-group-find-all'},
              etch.dom.button({ref: 'findAllButton', className: 'btn btn-all'}, 'Find All')
            )
          )
        ),

        etch.dom.section({className: 'input-block replace-container'},
          etch.dom.div({className: 'input-block-item input-block-item--flex editor-container'},
            etch.dom(TextEditor, {
              ref: 'replaceEditor',
              mini: true,
          ...
          etch.dom.div({className: 'input-block-item'},
            etch.dom.div({className: 'btn-group btn-group-replace'},
              etch.dom.button({ref: 'replaceNextButton', className: 'btn btn-next'}, 'Replace')
            ),

            etch.dom.div({className: 'btn-group btn-group-replace-all'},
              etch.dom.button({ref: 'replaceAllButton', className: 'btn btn-all'}, 'Replace All')
            )
          )
        ),
