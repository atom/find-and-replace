...
class FindView {
      ...
      <div tabIndex={-1} className='find-and-replace'>
        <header className='header'>
          ...
          <span className='header-item options-label pull-right'>
            ...
            <span ref='optionsLabel' className='options'></span>
        ...
        <section className='input-block find-container'>
          <div className='input-block-item input-block-item--flex editor-container'>
            <TextEditor ref='findEditor' mini placeholderText='Find in current buffer' buffer={this.findBuffer} />
            <div className='find-meta-container'>
              <span ref='resultCounter' className='text-subtle result-counter'></span>
            </div>
          </div>

          <div className='input-block-item'>
            <div className='btn-group btn-group-find'>
              <button ref='nextButton' className='btn btn-next'>Find</button>
            </div>

            <div className='btn-group btn-group-find-all'>
              <button ref='findAllButton' className='btn btn-all'>Find All</button>
            </div>
          </div>
        </section>
        ...
        <section className='input-block replace-container'>
          <div className='input-block-item input-block-item--flex editor-container'>
            <TextEditor ref='replaceEditor' mini placeholderText='Replace in current buffer' buffer={this.replaceBuffer}/>
          </div>

          <div className='input-block-item'>
            <div className='btn-group btn-group-replace'>
              <button ref='replaceNextButton' className='btn btn-next'>Replace</button>
            </div>

            <div className='btn-group btn-group-replace-all'>
              <button ref='replaceAllButton' className='btn btn-all'>Replace All</button>
            </div>
          </div>
        </section>
  ...
  createWrapIcon() {
    ...
    this.wrapIcon.classList.add('find-wrap-icon');
  }
  ...
  showWrapIcon(icon) {
    ...
    this.wrapIcon.className = icon;
    this.wrapIcon.style.opacity = 1;
    clearTimeout(this.wrapTimeout);
    this.wrapTimeout = setTimeout((() => this.wrapIcon.style.opacity = 0), 1000);
  }
};
