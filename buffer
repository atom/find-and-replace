...
BufferFindAndReplaceView = require 'find-and-replace/lib/buffer-find-and-replace-view'
BufferFindAndReplace = require 'find-and-replace/lib/buffer-find-and-replace'
